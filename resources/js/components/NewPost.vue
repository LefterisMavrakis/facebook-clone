...
<!--                    {{authUser.data.attributes.name}}-->
            ...
            <div class="flex-1 mx-4">
                <input type="text" name="body" class="w-full pl-4 h-8 bg-gray-200 rounded-full focus:outline-none focus:shadow-outline text-sm" :placeholder="'Add a post '+ authUser.data.attributes.name">
            </div>
            <div>
